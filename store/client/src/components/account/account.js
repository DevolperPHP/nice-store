...
export default function Account({ userReducer }) {
    ...
    const showOptions = () => {
        ...
        document.addEventListener('click', (e) => {
            ...
            if (e.target.id == 'open-menu' ) return
            else {
                ...
                <div className="flex-wrapper">
                    ...
                    <div className="user-dashboard">
                        <header>
                            ...
                            <FontAwesomeIcon onClick={showOptions} className="show-menu" id="open-menu" icon={faBars}/>
                            <FontAwesomeIcon onClick={hideOptions} className="hide-menu" id="close-menu" icon={faTimes}/>
                        </header>
