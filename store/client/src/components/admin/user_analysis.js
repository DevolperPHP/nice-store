...
export default function UsersAnalysis() {
    ...
    useEffect(async () => {
        ...
        if (res.data.done) setUsersGovernorate(res.data.data);
        const res2 = await axios(
            `${process.env.REACT_APP_SERVER_URL}/graph/users/gain?date=2`,
            { withCredentials: true }
        );
        if (res2.data.done) setUsersGain(res2.data.data);
    }, []);
    ...
    const usersGainChangeDate = async (e) => {
        ...
        if (res.data.done) setUsersGain(res.data.data);
            ...
            <div className="max-analysis">
                <div className="analysis-section">
                    ...
                    <div className="graph-container">
                        <Bar data={usersGovernorateData} options={{
                            responsive: true,
                ...
                <div className="analysis-section">
                    ...
                    <div className="graph-container">
                        <Line data={usersGainData} options={{
                            radius: 4,
                            hitRadius: 20,
                            tension: .4,
                            responsive: true,
