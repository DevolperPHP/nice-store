...
import CategoryProducts from './components/pages/category_products';
    ...
    return (
        <div className="App">
            <Router>
                ...
                <Route exact path="/category/:path" component={CategoryProducts} />
                ...
                <Route exact path="/edit/account">
                    {isLogin ? <EditAccount userReducer={userReducer} /> : <Redirect to="/" />}
                </Route>
            </Router>
        </div>
    );
